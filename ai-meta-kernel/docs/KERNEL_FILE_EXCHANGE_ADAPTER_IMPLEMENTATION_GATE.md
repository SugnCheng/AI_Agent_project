...
| Local invocation boundary | Minimal response/failure writers and the dry-run boundary exist, but no governed local invocation boundary exists for a full adapter run. |
